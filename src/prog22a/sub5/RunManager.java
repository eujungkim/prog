...
class Route {
	...
	@Override
	public String toString() {
		return "Route [pathPrefix=" + pathPrefix + ", url=" + url + ", responseTimeLimit=" + responseTimeLimit
				+ ", maxDelayCount=" + maxDelayCount + ", retryAfter=" + retryAfter + ", healthCheck=" + healthCheck
				+ "]";
	}
	String pathPrefix;
	String url;
